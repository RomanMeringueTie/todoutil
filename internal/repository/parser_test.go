...
func TestParseLine(t *testing.T) {
	...
	var actual = parseLine("parser.go", "// TODO: Add Test for parseLine [*]", "TODO: ")
	if !reflect.DeepEqual(expected, actual) {
		t.Errorf("expected: %v, actual: %v", expected, actual)
	}

	expected = model.NewTodo("Add Test for parseLine", model.Open, "parser.go")
	actual = parseLine("parser.go", "// TODO: Add Test for parseLine [o]", "TODO: ")
	if !reflect.DeepEqual(expected, actual) {
		t.Errorf("expected: %v, actual: %v", expected, actual)
	}

	expected = model.NewTodo("Add Test for parseLine", model.Closed, "parser.go")
	actual = parseLine("parser.go", "// TODO: Add Test for parseLine [x]", "TODO: ")
	if !reflect.DeepEqual(expected, actual) {
		t.Errorf("expected: %v, actual: %v", expected, actual)
	}

	expected = model.NewTodo("Add Test for parseLine", model.Open, "parser.go")
	actual = parseLine("parser.go", "// TODO: Add Test for parseLine", "TODO: ")
	if !reflect.DeepEqual(expected, actual) {
		t.Errorf("expected: %v, actual: %v", expected, actual)
	}

	expected = nil
	actual = parseLine("parser.go", "func getTodoNameAndStatus(line string) (string, model.Status) {", "TODO: ")
	if !reflect.DeepEqual(expected, actual) {
		t.Errorf("expected: %v, actual: %v", expected, actual)
	}
}
